#!/usr/bin/env python3
"""Record a remote (SSH/HPC/Modal) experiment run into Spark Agent provenance.
...
def main():
    p = argparse.ArgumentParser(description="Record a remote run into Spark Agent provenance.")
