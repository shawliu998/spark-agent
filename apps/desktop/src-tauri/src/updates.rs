...
const RELEASES_ATOM_URL: &str = "https://github.com/shawliu998/spark-agent/releases.atom";
...
fn fetch_latest_release() -> Result<ReleaseInfo, String> {
    let body = reqwest::blocking::Client::builder()
        .user_agent("Spark Agent update checker")
        .build()
...
<feed>
  <entry>
    ...
    <link rel="alternate" type="text/html" href="https://github.com/shawliu998/spark-agent/releases/tag/v0.1.8"/>
    <title>Spark Agent v0.1.8</title>
  </entry>
</feed>
"#;
        ...
        assert_eq!(
            ...
            ReleaseInfo {
                version: "v0.1.8".into(),
                url: "https://github.com/shawliu998/spark-agent/releases/tag/v0.1.8".into(),
                name: Some("Spark Agent v0.1.8".into()),
